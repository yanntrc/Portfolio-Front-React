...
const Showcase = () => {
    ...
    <section className="showcase">
        <div className="overlay flex flex-col items-center justify-center text-white px-5 ">
            ...
            I create <span className="text-green-500">brand awareness</span>  for small businesses
            </h1>
            <div className="ml-auto lg:ml-0">
                 <Link to="/hire" className="mr-5 bg-green-500 p-2 px-4 rounded-full font-semibold transition-all hover:bg-green-800">Get Started</Link>
